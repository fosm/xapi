...
updateTag(qsOld,qsNew,nodeId,key,newValue,newChangeset,newVersion,delete)	; Private ; Update (add/modify/delete) a key/value pair for a node
	...
	s ^changeset(newChangeset,"n",nodeId,"v",newVersion,"u",u)=newValue
	;
	...
	. . i qsOld'="",qsOld'=qsNew k ^element(qsOld,"n",nodeId,"u",u)
	. . i qsNew'="" s ^element(qsNew,"n",nodeId,"u",u)=newValue
	. ;
